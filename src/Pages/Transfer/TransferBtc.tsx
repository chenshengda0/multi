...
const TransferBtcParent = function(SonComponent:any){
...
class TransferBtc extends Component<any>{
    ...
    render(){
        return (
            <>
                <CommonBackHeaderComponent title="轉帳" backUrl="/money_btc_info"></CommonBackHeaderComponent>
...
export default TransferBtcParent( TransferBtc );