...
const TransferBscParent = function(SonComponent:any){
...
class TransferBsc extends Component<any>{
    ...
    render(){
        return (
            <>
                <CommonBackHeaderComponent title="轉帳" backUrl="/money_bsc_info"></CommonBackHeaderComponent>
...
export default TransferBscParent( TransferBsc );