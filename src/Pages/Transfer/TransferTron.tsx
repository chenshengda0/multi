...
const TransferTronParent = function(SonComponent:any){
    class PackageComponent extends Component<any>{
        ...
        async UNSAFE_componentWillMount(){
            ...
            const provider = new TronWeb({
                fullHost: this.props.defaultRPC,
...
class TransferTron extends Component<any>{
    ...
    render(){
        return (
            <>
                <CommonBackHeaderComponent title="轉帳" backUrl="/money_tron_info"></CommonBackHeaderComponent>
...
export default TransferTronParent( TransferTron );