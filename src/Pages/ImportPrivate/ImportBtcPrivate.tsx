...
const ImportBtcPrivateParent = function(SonComponent:any){
...
class ImportBtcPrivate extends Component<any>{
...
export default ImportBtcPrivateParent( ImportBtcPrivate )