...
const ImportEthPrivateParent = function(SonComponent:any){
...
class ImportEthPrivate extends Component<any>{
...
export default ImportEthPrivateParent( ImportEthPrivate )